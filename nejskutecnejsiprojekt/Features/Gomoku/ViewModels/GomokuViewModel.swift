...
final class GomokuViewModel: ObservableObject {
    ...
    init(
        ...
        self.hapticsService = hapticsService ?? HapticsService.shared
        
        // Initialize empty board
        self.board = Array(repeating: Array(repeating: nil, count: cfg.size), count: cfg.size)
